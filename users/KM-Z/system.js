...
if (n == 1) {
    ...
    if (h >= 8) {
      ...
      document.getElementById('youhaveNextClass').innerHTML = '504';
    }

    // Science
    if (h >= 11) {
      document.getElementById('youhaveNow').innerHTML = 'CAEP';
      document.getElementById('youhaveNowClass').innerHTML = '504';
    ...
    if (h >= 12) {
      ...
      //nextup
      document.getElementById('youhaveNext').innerHTML = 'VET11 Construction ';
      document.getElementById('youhaveNextClass').innerHTML = 'N/A';
    }

    // Graphic Design
    if (h >= 13) {
      document.getElementById('youhaveNow').innerHTML = 'VET11 Construction';
